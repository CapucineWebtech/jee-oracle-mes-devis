...
public class ProductXEstimateDto {
    ...
    public ProductXEstimateDto() {
    }

    public ProductXEstimateDto(long idProductXEstimate, float price, long inventory, long estimateId, long productId) {
